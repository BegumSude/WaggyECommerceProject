...
namespace WaggyProject.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        private readonly object ImageFile;
        ...
        public IActionResult AddProduct(Product model)
        {
            if (model.ImageFile != null)
            {
                ...
                var fileName = Guid.NewGuid().ToString();  //unique bir guide değeri oluşturur kaydedince.
        ...
        [HttpPost]
        public IActionResult UpdateProduct(ProductController model)
        {
